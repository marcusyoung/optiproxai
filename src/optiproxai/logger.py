"""Routing logger for OptiProxAI classification decisions.
...
if TYPE_CHECKING:
    from optiproxai.scorer import ClassificationResult
...
_LOG_DIR = (
    Path(os.environ.get("OPTIPROXAI_LOG_DIR", ""))
    if os.environ.get("OPTIPROXAI_LOG_DIR")
