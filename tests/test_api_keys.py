"""Tests for OptiProxAI API key management."""

from __future__ import annotations

import pytest

from optiproxai.api_keys import (
    generate_key,
    has_keys,
    list_keys,
    remove_key,
...
class TestApiKeyLifecycle:
    ...
    def test_generate_and_validate(self):
        ...
        assert raw.startswith("optiproxai-")
    ...
    def test_malformed_or_oversized_key_rejected(self):
        generate_key("test-key")
        assert validate_key("bogus-key") is False
        assert validate_key("optiproxai-" + "x" * 252) is False
    ...
    def test_remove_by_prefix(self):
        ...
        prefix = raw.removeprefix("optiproxai-")[:8]
