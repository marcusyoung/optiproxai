...
from optiproxai.config import EmbeddingConfig, OptiproxaiConfig, ProviderConfig
...
def test_build_embedding_client_raises_when_embedding_disabled(
    ...
    monkeypatch.setattr("optiproxai.feature_training.load_config", lambda: cfg)
...
def test_train_feature_classifier_writes_model_bundle(
    ...
    monkeypatch.setattr(
        "optiproxai.feature_training.load_or_compute_embeddings",
    ...
    monkeypatch.setattr(
        "optiproxai.feature_training.build_embedding_client",
