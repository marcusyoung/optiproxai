...
from optiproxai.scorer import LocalEmbeddingBackend
...
def test_training_local_embedding_records_configured_model_identity(
    ...
    monkeypatch.setenv("OPTIPROXAI_CONFIG", str(tmp_path / "config.yaml"))
...
"""
    ...
    monkeypatch.setattr(
        "optiproxai.feature_training.LocalEmbeddingBackend", _FakeLocalEmbeddingBackend
    )
